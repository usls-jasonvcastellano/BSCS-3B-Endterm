            ...
            <div class="panel-body">
                <form action="/items" method="POST">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="item_name" id="item_name_field" placeholder="Item Name">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="qty_field" class="col-sm-3 col-form-label mb-3">Quantity</label>
                        <div class="col-sm-9">
                            <input type="number" class="form-control" name="qty" id="qty_field" placeholder="Item Quantity">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="price_field" class="col-sm-3 col-form-label mb-3">Price</label>
                        <div class="col-sm-9">
                            <input type="decimal" class="form-control" name="price" id="price_field" placeholder="Item Price">
                        </div>
                    </div>
                    <div class="text-center">
                        <button type="submit" class="btn btn-primary col-3">Save Item</button>
                    </div>
                </form>
            </div>
        </div>
